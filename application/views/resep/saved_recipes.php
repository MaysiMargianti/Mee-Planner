  ...
  <section class="breadcrumbs">
    <div class="container">
      <div class="d-flex justify-content-between align-items-center">
        <h2><strong>Koleksi Resep Anda</strong></h2>
      </div>
    </div>
        ...
        <?php foreach ($saved_recipes as $recipe): ?>
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                ...
                <img src="<?php echo base_url('uploads/' . $recipe['img_recipe']); ?>" class="img-fluid" alt="<?php echo $recipe['recipe_name']; ?>">
                    <h4><?php echo isset($recipe['recipe_name']) ? $recipe['recipe_name'] : 'No name'; ?></h4>
                    <p><?php echo isset($recipe['category']) ? $recipe['category'] : 'No category'; ?></p>
