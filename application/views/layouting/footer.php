 ...
 <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Mee Plan 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="<?php echo base_url()?>assets1/js/demo/chart-area-demo.js"></script>
    <script src="<?php echo base_url()?>assets1/js/demo/chart-pie-demo.js"></script>
